...
class ConnectionHandler:
    ...
    async def handle_connection(self, ws: websockets.ServerConnection):
        try:
            ...
            if self.device_id and hasattr(self.server, 'connections'):
                self.server.connections[self.device_id] = self
            ...
            try:
                ...
                if self.device_id and hasattr(self.server, 'connections'):
                    self.server.connections.pop(self.device_id, None)
    ...
    async def _route_message(self, message):
        ...
        if isinstance(message, str):
            ...
            if self.is_bridge:
                ...
                if target:
                    await target.websocket.send(message)
                return
